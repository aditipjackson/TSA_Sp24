...
## when use the original dataset, bad fit b/c we haven't accounted for trend and seasonality of data set
...
## better than the overall mean; if you have a trend, it's actually better to repeat the previous information than taking the mean of the series
...
## considers the last year but without seasonality
...
autoplot(ts_electricity_price[,"All.sectors"],
         series="Original")+
  autolayer(Model6$forecast,series="MA")
...
# has to be in 2 steps for arima
...
autoplot(ts_electricity_price[,"All.sectors"],
  ...
  autolayer(Model9_for$mean,series="SARIMA")
...
autoplot(deseasonal_allsectors_price, series="Deseasonal")+
  autolayer(Model10$fitted,series="SARIMA")+
  autolayer(Model10_for$mean,series="SARIMA")

# this model is able to handle the trend, replicates trend into the future
# errors will be smaller b/c took out seasonal component

# not fair to compare errors from arima and sarima models b/c different variability
