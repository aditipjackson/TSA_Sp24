...
Model_autofit <- auto.arima(
  deseasonal_residential_price,
  max.D=0,
  max.P=0,
  max.Q=0)
# forcing seasonal components to be 0
# lowercase p,d,q will be for non-seasonal part, uppercase will be for seasonal part
print(Model_autofit)

Model_101 <- Arima(deseasonal_residential_price)
