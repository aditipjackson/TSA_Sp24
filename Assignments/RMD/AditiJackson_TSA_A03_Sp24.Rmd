...
# plotting all three time series: Biomass Prod, Renewables Prod, Hydro Consumption
for(i in 1:ncolumns){
  print(ggplot(renewable_energy_sub,aes(x=Date,y=renewable_energy_sub[,(1+i)]))+
...
for(i in 1:ncolumns){
  par(mfrow=c(1,2))
  Acf(renewable_energy_ts[,i],lag.max=40,main=paste("TS:",i,sep=""))
  Pacf(renewable_energy_ts[,i],lag.max=40,main=paste("TSL",i,sep=""))
}
