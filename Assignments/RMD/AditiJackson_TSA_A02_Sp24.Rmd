...
# transforming data into ts object; start date is Jan 1, 1973; frequency is 12 (monthly data)
renewable_energy_ts <- ts(renewable_energy_sub[,4],start=c(1973,1),frequency=12)
...
# calculating mean and standard deviation for time series. I'm not sure this is correct since it's giving 1 value for all three columns
...
# NOTE: Used chatGPT to determine which function to use to calculate correlation between all three time series
cor_matrix <- 
...
TS_acf <- Acf(renewable_energy_ts,lag.max=40,type="correlation",plot=TRUE)
